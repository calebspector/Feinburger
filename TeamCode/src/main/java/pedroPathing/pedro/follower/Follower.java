package pedroPathing.pedro.follower;

import static pedroPathing.pedro.follower.FollowerConstants.automaticHoldEnd;
import static pedroPathing.pedro.follower.FollowerConstants.cacheInvalidateSeconds;
import static pedroPathing.pedro.follower.FollowerConstants.drivePIDFFeedForward;
import static pedroPathing.pedro.follower.FollowerConstants.drivePIDFSwitch;
import static pedroPathing.pedro.follower.FollowerConstants.forwardZeroPowerAcceleration;
import static pedroPathing.pedro.follower.FollowerConstants.headingPIDFFeedForward;
import static pedroPathing.pedro.follower.FollowerConstants.headingPIDFSwitch;
import static pedroPathing.pedro.follower.FollowerConstants.lateralZeroPowerAcceleration;
...
import static pedroPathing.pedro.follower.FollowerConstants.nominalVoltage;
...
import static pedroPathing.pedro.follower.FollowerConstants.secondaryDrivePIDFFeedForward;
import static pedroPathing.pedro.follower.FollowerConstants.secondaryHeadingPIDFFeedForward;
import static pedroPathing.pedro.follower.FollowerConstants.secondaryTranslationalPIDFFeedForward;
import static pedroPathing.pedro.follower.FollowerConstants.translationalPIDFFeedForward;
import static pedroPathing.pedro.follower.FollowerConstants.translationalPIDFSwitch;
import static pedroPathing.pedro.follower.FollowerConstants.useSecondaryDrivePID;
import static pedroPathing.pedro.follower.FollowerConstants.useSecondaryHeadingPID;
import static pedroPathing.pedro.follower.FollowerConstants.useSecondaryTranslationalPID;
import static pedroPathing.pedro.follower.FollowerConstants.useVoltageCompensationInAuto;
import static pedroPathing.pedro.follower.FollowerConstants.useVoltageCompensationInTeleOp;
...
import pedroPathing.pedro.util.CustomFilteredPIDFCoefficients;
import pedroPathing.pedro.util.CustomPIDFCoefficients;
...
import pedroPathing.pedro.pathgen.BezierPoint;
import pedroPathing.pedro.pathgen.MathFunctions;
import pedroPathing.pedro.pathgen.Path;
import pedroPathing.pedro.pathgen.PathBuilder;
import pedroPathing.pedro.pathgen.PathCallback;
...
import pedroPathing.pedro.util.DashboardPoseTracker;
import pedroPathing.pedro.util.Drawing;
import pedroPathing.pedro.util.FilteredPIDFController;
import pedroPathing.pedro.util.KalmanFilter;
import pedroPathing.pedro.util.PIDFController;
